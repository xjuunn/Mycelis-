<template>
    <div class="h-full flex flex-col">
        <div class="h-13 border-b border-b-base-content/10 bg-base-200 pl-3 pr-3 flex items-center gap-3">
            <div class="text-lg pl-3 pr-3">搜索</div>
        </div>
        <div class="flex-1 flex-col p-8 flex items-center">
            ...
            <div class="mt-5 max-w-[500px] w-full place-self-center">
...
async function btnAddFriend(item: Types.User) {
    let { data } = await Friend.FriendRequest.create(item.id);
    console.log(data);
